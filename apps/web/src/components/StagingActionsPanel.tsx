...
export default function StagingActionsPanel({
  siteId,
  stagingReady,
  canFlushCache,
  canSyncStaging
        ...
        <div className="panel-row">
          <div className="panel-row__body">
            ...
            <p className="panel-row__help">
              Clears the staging site&apos;s object cache, page cache files, Redis, Elementor&apos;s generated CSS and — when it is behind Cloudflare — its edge cache.
            </p>
