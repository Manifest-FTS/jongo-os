...
import { BellIcon, BuildingOfficeIcon, ChartBarIcon, DashboardIcon, ServerIcon, SettingsIcon } from "@/components/JongoIcons";
...
const navItems: NavItem[] = [
  ...
  { href: "/usage", label: "Usage", icon: ChartBarIcon, match: "prefix" },
