...
- Core staging-to-production behavior has an executable smoke script (`npm run smoke:staging-promote`) that validates blocked schema, idempotency replay, and promote-attempt status lookup.
